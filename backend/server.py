...
def send_dishes():
    user_id = 'User_71'
    profiles = pd.read_csv('./datasets/user_Profiles.csv') # profiles of all users
    recent_activity = pd.read_csv('./datasets/recent_activity.csv') # recent activities of current user (meals liked,rated,searched,Purchased)
